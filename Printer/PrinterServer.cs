   ...
   public class PrinterServer
    {
       ...
       private void PrintBill(PrintPageEventArgs e)
       {
           ...
           posPrinter.DrawLine("", new Font("Arial", 14), e, System.Drawing.Drawing2D.DashStyle.Dot, l_y, 1);
           posPrinter.DrawString("G.S.T Content:", e, new Font("Arial", 10, FontStyle.Bold), l_y, 1);
           Double gst = Convert.ToDouble(OrderMain.TotalAmount) / 11000;
           if(gst<1)
                l_y = posPrinter.DrawString("$0" + money.Format2(Convert.ToDouble(OrderMain.TotalAmount)/11), e, new Font("Arial", 10), l_y, 3);
           else
               l_y = posPrinter.DrawString("$" + money.Format2(Convert.ToDouble(OrderMain.TotalAmount) / 11), e, new Font("Arial", 10), l_y, 3);
           //posPrinter.DrawLine("", new Font("Arial", 14), e, System.Drawing.Drawing2D.DashStyle.Dot, l_y, 1);
           //posPrinter.DrawString("Total:", e, new Font("Arial", 10, FontStyle.Bold), l_y, 1);
           //l_y = posPrinter.DrawString("$" + money.Format2(Convert.ToDouble(OrderMain.TotalAmount)), e, new Font("Arial", 10), l_y, 3);
           ...
           {
               posPrinter.DrawString("Account:", e, new Font("Arial", 10), l_y, 1);
               l_y = posPrinter.DrawString("$" + money.Format2(Convert.ToDouble(OrderMain.SubTotal())), e, new Font("Arial", 10), l_y, 3);
               posPrinter.DrawString("AccountName:", e, new Font("Arial", 10), l_y, 1);
               l_y = posPrinter.DrawString(OrderMain.CusItem.Fname, e, new Font("Arial", 10), l_y, 3);
           }
           l_y += posPrinter.GetHeightPrinterLine() / 2;
           l_y = posPrinter.DrawString(cofig.Web, e, new Font("Arial", 10), l_y, 2);
           l_y = posPrinter.DrawString(cofig.Logan, e, new Font("Arial", 10), l_y, 2);
